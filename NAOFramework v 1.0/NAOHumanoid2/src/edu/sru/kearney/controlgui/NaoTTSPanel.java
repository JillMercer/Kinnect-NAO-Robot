...
/**
 * Text To Speech Panel Last Edited, 11/30/2015
 * 
 * @author Zachary Kearney
 */

public class NaoTTSPanel extends NaoPanel implements NaoPanelInterface {
	...
	public NaoTTSPanel() {
		...
		txtTextToSpeech.setBounds(10, 274, 119, 20);
		add(txtTextToSpeech);
		txtTextToSpeech.setColumns(10);

		btnTalk = new JButton("Talk");

		btnTalk.setBounds(138, 273, 109, 23);
		add(btnTalk);
