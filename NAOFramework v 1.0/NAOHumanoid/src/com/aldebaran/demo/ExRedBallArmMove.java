	        	 ...
	        	 public void onBallDetected(Object param) throws InterruptedException, CallError 
		            {
	        		 		if(!isRedBallDetected)
	        		 		{
	        		 			...
	        		 			//armPos = alTracker.getTargetPosition();
		        		 		//armPos.add(new Float(1.4295573f));
		        		 		//armPos.add(new Float(0.020576123f));
		        		 		//armPos.add(new Float(-0.02710073f));
		        		 		//alMotion.setPositions("RArm", 1, armPos, 0.8f, 7);
	        		 		}
