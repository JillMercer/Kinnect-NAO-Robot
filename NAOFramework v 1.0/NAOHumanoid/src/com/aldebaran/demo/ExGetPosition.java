...
public class ExGetPosition{
	...
	public void runNAO() {
        ...
        try {
	        ...
	        System.out.println("RHand position: "+alMotion.getPosition("RHand", 1, true));
	        //System.out.println("RHand Angle: "+alMotion.getAngles("RHand", false));
	        //System.out.println("RWristYaw Angle: "+alMotion.getAngles("RWristYaw", false));
