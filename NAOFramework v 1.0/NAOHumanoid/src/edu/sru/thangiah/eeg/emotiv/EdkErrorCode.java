...
/**
 * 
 * This is an enumeration representing the error codes that can be
 * generated by the Emotiv EEG SDK. The representation of these errors
 * have been mapped using the JNA Library
 * 
 * @author Marc S
 *
 */
