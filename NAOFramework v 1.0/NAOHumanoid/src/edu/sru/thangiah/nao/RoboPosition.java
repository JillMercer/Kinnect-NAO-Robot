...
public class RoboPosition
{
	...
	{	
		...
		if (((skeletons[0].get3DJointX(5) - skeletons[0].get3DJointX(6)) < difference)&&
				((skeletons[0].get3DJointY(5) - skeletons[0].get3DJointY(6)) > difference)&&
				((skeletons[0].get3DJointZ(5) - skeletons[0].get3DJointZ(6)) < difference))	
		{
		...
		else if (((skeletons[0].get3DJointX(5) - skeletons[0].get3DJointX(6)) > difference)&&
				((skeletons[0].get3DJointY(5) - skeletons[0].get3DJointY(6)) < difference)&&
				((skeletons[0].get3DJointZ(5) - skeletons[0].get3DJointZ(6)) < difference))	
		{
		...
		if (((skeletons[0].get3DJointX(9) - skeletons[0].get3DJointX(10)) < difference)&&
				((skeletons[0].get3DJointY(9) - skeletons[0].get3DJointY(10)) > difference)&&
				((skeletons[0].get3DJointZ(9) - skeletons[0].get3DJointZ(10)) < difference))	
		{
			motion.setAngles("RShoulderPitch", 1.5708, 0.5f); 
			motion.setAngles("RShoulderRoll", 0, 0.5f); 
		}
		//right arm out to side		
		else if (((skeletons[0].get3DJointX(9) - skeletons[0].get3DJointX(10)) > difference)&&
				((skeletons[0].get3DJointY(9) - skeletons[0].get3DJointY(10)) < difference)&&
				((skeletons[0].get3DJointZ(5) - skeletons[0].get3DJointZ(6)) < difference))	
		{
