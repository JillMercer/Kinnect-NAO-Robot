...
public class CamFrame extends JFrame {
	...
	public CamFrame(SynchronizedConnect sync, String name) throws Exception{
	...
	public void run() {
		...
		CamFrameMouseAdapter mouseListener = new CamFrameMouseAdapter(motion, camTopDef.getWidth(), camTopDef.getHeight());
		camTopDef.addMouseListener(mouseListener);
		camTopDef.addMouseMotionListener(mouseListener);
		camTopEdge.addMouseListener(mouseListener);
		camTopEdge.addMouseMotionListener(mouseListener);
		camTopDual.addMouseListener(mouseListener);
		camTopDual.addMouseMotionListener(mouseListener);
		camBotDef.addMouseListener(mouseListener);
		camBotDef.addMouseMotionListener(mouseListener);
		camBotEdge.addMouseListener(mouseListener);
		camBotEdge.addMouseMotionListener(mouseListener);
		camBotDual.addMouseListener(mouseListener);
		camBotDual.addMouseMotionListener(mouseListener);
	}
