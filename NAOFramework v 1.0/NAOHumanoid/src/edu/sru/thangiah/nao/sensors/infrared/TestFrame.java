...
public class TestFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TestFrame frame = new TestFrame(RobotConfig.getConnectionString());
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TestFrame frame = new TestFrame("tcp://" + "192.168.0.101" + ":" + PORT);
					frame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
	 ...
	 * Create the frame.
	 */
	public TestFrame(String connectStr) {
	...
	public void initializeNAO(String connectStr)
	{
		...
		args = new String[1];
		args[0] = new String();
		Application app = new Application(args, connectStr);
		Session session;
		/*
