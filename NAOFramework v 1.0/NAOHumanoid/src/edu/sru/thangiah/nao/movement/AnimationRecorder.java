...
* @author zrk1002
* Module used to record animations. Change the IP and Joints arraylist in main to utilize.
* The top and bottom buttons on the NAO's head are used to scroll through options.
* The middle button is to execute and stop.
*/
...
public class AnimationRecorder {
	...
	public static void main(String args[]){
		try {
			new AnimationRecorder(Joints.arms, "192.168.0.116");
		} catch (Exception e) {
