...
/**
 * File: GeneratePrunedDescisionTree.java
 * @author Brian Atwell
 * Description: This generates a descision tree for tic tac toe AI.
 * This is suppose to leave branches that have same out come. But
 * it did not work.
 * @deprecated
 *
 */
public class GeneratePurnedDescisionTree {
	...
	public GeneratePurnedDescisionTree()
	{
	...
	public void newNode(int level, NaryTree node)
	{
		...
		//{
		if(level>0 && size>0 && game.isAlive())
		{
			int wins=0;
			int losses=0;
			int ties=0;
	...
	private static void testWinPropagation()
	{
		...
		int numErrors=0;
		int numEndNodes=0;
		GeneratePurnedDescisionTree treeGen = new GeneratePurnedDescisionTree();
